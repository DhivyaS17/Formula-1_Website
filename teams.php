  ...
  <div class="flip-card-inner">
    ...
    <!-- card back -->
      <div class="flip-card-back">
            ...
            <!-- card1 -->
                        <div class="card">
                        <img src="f1_images/bot.png" alt="Avatar" width="128px" height="220px" class="card-img-top">
                                <div class="card-body">
                    ...
                    <!-- card 2 --->
                    <div class="card">
                    <img src="f1_images/zhou_profile1.png" alt="Avatar" width="128px" height="220px" class="card-img-top" style="float:right;">
                            <div class="card-body">
...
<div class="flip-card">
  <div class="flip-card-inner">
    <div class="flip-card-front">
      <div class="card">
      <img src="f1_images/alphatauri1.jpg" alt="Avatar" width="128px" height="220px" class="card-img-top" style="object-fit: contain;">
       <div class="card-body">
    ...
    <!-- card back -->
      <div class="flip-card-back">
            ...
            <!-- card1 -->
                        <div class="card">
                        <img src="f1_images/gasly_profile1.png" alt="Avatar" width="128px" height="220px" class="card-img-top">
                                <div class="card-body">
            ...
            <!-- card 2 --->
                    <div class="card">
                    <img src="f1_images/yuki_profile1.png" alt="Avatar" width="128px" height="220px" class="card-img-top">
                            <div class="card-body">
  ...
  <div class="flip-card-inner">
    ...
    <!-- card back -->
      <div class="flip-card-back">
            ...
            <!-- card1 -->
                        <div class="card">
                        <img src="f1_images/alonso_profile1.png" alt="Avatar" width="128px" height="220px" class="card-img-top">
                                <div class="card-body">
            ...
            <!-- card 2 --->
                    <div class="card">
                    <img src="f1_images/ocon_profile1.png" alt="Avatar" width="128px" height="220px" class="card-img-top">
                            <div class="card-body">
  ...
  <div class="flip-card-inner">
    ...
    <!-- card back -->
      <div class="flip-card-back">
            ...
            <!-- card1 -->
                        <div class="card">
                        <img src="f1_images/vettel_profile1.png" alt="Avatar" width="128px" height="220px" class="card-img-top">
                                <div class="card-body">
            ...
            <!-- card 2 --->
                    <div class="card">
                    <img src="f1_images/stroll_profile1.png" alt="Avatar" width="128px" height="220px" class="card-img-top">
                            <div class="card-body">
  ...
  <div class="flip-card-inner">
    ...
    <!-- card back -->
      <div class="flip-card-back">
            ...
            <!-- card1 -->
                        <div class="card">
                        <img src="f1_images/leclerc_profile1.png" alt="Avatar" width="128px" height="220px" class="card-img-top">
                                <div class="card-body">
            ...
            <!-- card 2 --->
                    <div class="card">
                    <img src="f1_images/sainz_profile1.png" alt="Avatar" width="128px" height="220px" class="card-img-top">
                            <div class="card-body">
  ...
  <div class="flip-card-inner">
    ...
    <!-- card back -->
      <div class="flip-card-back">
            ...
            <!-- card1 -->
                        <div class="card">
                        <img src="f1_images/mick_profile1.png" alt="Avatar" width="128px" height="220px" class="card-img-top">
                                <div class="card-body">
            ...
            <!-- card 2 --->
                    <div class="card">
                    <img src="f1_images/k-mag_profile1.png" alt="Avatar" width="128px" height="220px" class="card-img-top">
                            <div class="card-body">
  ...
  <div class="flip-card-inner">
    ...
    <!-- card back -->
      <div class="flip-card-back">
            ...
            <!-- card1 -->
                        <div class="card">
                        <img src="f1_images/daniel_profile1.png" alt="Avatar" width="128px" height="220px" class="card-img-top">
                                <div class="card-body">
            ...
            <!-- card 2 --->
                    <div class="card">
                    <img src="f1_images/lando_profile1.png" alt="Avatar" width="128px" height="220px" class="card-img-top">
                            <div class="card-body">
  ...
  <div class="flip-card-inner">
    ...
    <!-- card back -->
      <div class="flip-card-back">
            ...
            <!-- card1 -->
                        <div class="card">
                        <img src="f1_images/lewis_profile1.png" alt="Avatar" width="128px" height="220px" class="card-img-top">
                                <div class="card-body">
            ...
            <!-- card 2 --->
                    <div class="card">
                    <img src="f1_images/russell_profile1.png" alt="Avatar" width="128px" height="220px" class="card-img-top">
                            <div class="card-body">
  ...
  <div class="flip-card-inner">
    ...
    <!-- card back -->
      <div class="flip-card-back">
            ...
            <!-- card1 -->
                        <div class="card">
                        <img src="f1_images/max_profile1.png" alt="Avatar" width="128px" height="220px" class="card-img-top">
                                <div class="card-body">
            ...
            <!-- card 2 --->
                    <div class="card">
                    <img src="f1_images/checo_profile1.png" alt="Avatar" width="128px" height="220px" class="card-img-top">
                            <div class="card-body">
  ...
  <div class="flip-card-inner">
    ...
    <!-- card back -->
      <div class="flip-card-back">
            ...
            <!-- card1 -->
                        <div class="card">
                        <img src="f1_images/latifi_profile1.png" alt="Avatar" width="128px" height="220px" class="card-img-top">
                                <div class="card-body">
            ...
            <!-- card 2 --->
                    <div class="card">
                    <img src="f1_images/al2.png" alt="Avatar" width="128px" height="220px" class="card-img-top">
                            <div class="card-body">
